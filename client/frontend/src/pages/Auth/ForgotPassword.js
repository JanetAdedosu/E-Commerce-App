  ...
  return (
    <Layout title='Forgot Password - Ecommerce App'>
      ...
      <form onSubmit ={handleSubmit}>
        <h4 className="title">RESET PASSWORD HERE</h4>
   ...
   <div className="mb-3">
     <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail" 
     placeholder ="Enter Your Favorite Food" required/>
   </div>
